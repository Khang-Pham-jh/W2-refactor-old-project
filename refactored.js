...
// Tree Store Module
const createTreeStoreFactory = ({ deepClone, normalizeNode, isResultNode, startNodeId }) => {
    const lockedStartNodeId = String(startNodeId || '').trim();
...
const createTreeStore = createTreeStoreFactory({
    deepClone,
    normalizeNode,
    isResultNode,
...
window.TreeManagerApp = Object.freeze({
    createTreeStore,
    createTreeNavigator,
    ...
    getTreeSnapshot: () => treeStore.getTreeSnapshot(),
    getCurrentNodeId: () => navigator.getCurrentNodeId(),
});
